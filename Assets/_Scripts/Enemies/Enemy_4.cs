...
public class Enemy_4 : Enemy
{
    ...
    void InitMovement()
    {
        ...
        float widMaxRad = bndCheck.camWidth - bndCheck.radius;
        float hgtMinRad = bndCheck.camHeight - bndCheck.radius;
        float hgtMaxRad = bndCheck.camHeight - bndCheck.radius;
        p1.x = Random.Range(-widMinRad, widMaxRad);
        p1.y = Random.Range(-hgtMinRad, hgtMaxRad);
    ...
    public override void Move()
    {
        ...
        u = u - 0.15f * Mathf.Sin(u * Mathf.PI * 2);
        pos = (1 - u) * p0 + u * p1;
    }
